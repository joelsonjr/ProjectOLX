...
QT_MOC_LITERAL(4, 43, 5) // "reply"
    ...
    "FileDownload\0replyFinished\0\0QNetworkReply*\0"
    "reply"
};
...
void FileDownload::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FileDownload *_t = static_cast<FileDownload *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject FileDownload::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileDownload.data,
      qt_meta_data_FileDownload,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
